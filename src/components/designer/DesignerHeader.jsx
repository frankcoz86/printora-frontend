...
const DesignerHeader = ({ 
    ...
    <header className="flex flex-col md:flex-row items-center md:justify-between justify-start p-2 md:p-3 gap-2 md:gap-0 bg-slate-900 shadow-md z-30 shrink-0">
