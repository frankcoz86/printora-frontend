...
const BannerDev1Page = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Striscioni Banner DEV1 | Printora</title>
                <meta name="description" content="Versione DEV1 della pagina banner, con offerta dedicata." />
                <meta name="keywords" content="striscioni dev, banner pvc, offerte speciali, printora" />
            </Helmet>
