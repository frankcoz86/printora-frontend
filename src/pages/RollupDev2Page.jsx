...
const RollupDev2Page = () => {
    ...
    const handleOpenEditor = () => {
        ...
        navigate('/designer/rollup', {
          state: {
            designState: {
              product: rollupProduct,
              width,
              height,
              quantity,
              extras: [],
    ...
    return (
        <>
            <Helmet>
                <title>Roll-up DEV2 | Printora</title>
                <meta name="description" content="Versione DEV2 della pagina roll-up, con editor gratuito e offerta dedicata." />
                <meta name="keywords" content="rollup dev, editor rollup, offerte speciali, printora" />
            </Helmet>
                ...
                <div className="container mx-auto px-4 pt-16 pb-20 text-center relative">
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="relative z-10">
                        <h1 className="relative z-20 text-4xl md:text-6xl font-extrabold leading-[1.25] tracking-tight text-cyan-300">
                           {"Crea il tuo Roll-up con l'"}
                           <span className="text-cyan-100">editor gratuito</span>
                        </h1>
                        <p className="mt-[21px] text-[23px] text-gray-300 max-w-3xl mx-auto">
                            50% di sconto se ordini adesso e Spedizione in 24 h
                        </p>
