...
const BannerPageLocal = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Stampa Striscioni Banner in PVC | DEV COPY | Printora</title>
                <meta name="description" content="Versione di sviluppo della pagina banner. Visibile solo in ambiente locale." />
                <meta name="keywords" content="stampa striscioni, banner pvc, striscioni personalizzati, stampa grande formato, printora, dev" />
            </Helmet>
                ...
                <div className="container mx-auto px-4 pt-16 pb-20 text-center relative">
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="relative z-10">
                        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-emerald-300 to-green-300">
                           Striscioni PVC Professionali, Pronti Quando Ti Servono da 8,90 euro a m/q
                        </h1>
                        <p className="mt-4 text-lg text-gray-300 max-w-3xl mx-auto">
                            Per cantieri, eventi e agenzie: prezzi chiari, preventivo immediato online e produzione rapida.
 Così non perdi tempo e non rischi brutte sorprese prima dell’allestimento.
                        </p>
                    </motion.div>
                </div>
            </div>
...
export default BannerPageLocal;
