        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          >
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
              La checklist professionale in <span className="text-blue-400 font-semibold">7 punti</span> che i nostri operatori usano ogni giorno per <span className="text-blue-400 font-semibold">verificare i file</span> prima della stampa.{' '}
