...
const BannerDev3Page = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Striscioni Banner DEV3 | Printora</title>
                <meta name="description" content="Versione DEV3 della pagina banner, con garanzia spedizione 24h o rimborso." />
                <meta name="keywords" content="striscioni dev, banner pvc, spedizione 24h, printora" />
            </Helmet>
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="relative z-10">
                        <h1 className="relative z-20 text-4xl md:text-6xl font-extrabold leading-[1.25] tracking-tight text-emerald-300">
                            ...
                            <span className="block">
                                o <span className="text-emerald-100">rimborso completo</span>
                            </span>
                        </h1>
